    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatabaseReference ref6 = FirebaseDatabase.getInstance().getReference().child("LODGING CAPACITY").child(sqsize.getSelectedItem().toString());
...
//                        t3.setText(Integer.toString(5-Integer.parseInt(s)));
        ...
        t2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(LodgingActivity.this, LodgingResetActivity.class);
                startActivity(i);
            }
        });
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (name.getText().toString().equals("") || address.getText().toString().equals("") || sqsize.getSelectedItem().toString().equals("") || phn.getText().toString().equals("") || date.getText().toString().equals("") || time.getText().toString().equals("")) {
                    Toast.makeText(LodgingActivity.this, "FILL ALL THE FIELDS", Toast.LENGTH_SHORT).show();
                } else {
                    if (t3.getText().toString() == "FETCH AVAILABILITY") {
                        Toast.makeText(LodgingActivity.this, "MAKE CHECKBOX TRUE", Toast.LENGTH_SHORT).show();
                    } else {
                        int z = Integer.parseInt(t3.getText().toString());
                        if (z == 0 || z < 0) {
                            Toast.makeText(LodgingActivity.this, "MENTION SQUAD SIZE TABLE IS NOT AVAILABLE", Toast.LENGTH_SHORT).show();
                        } else {
                            Intent t = new Intent(LodgingActivity.this, LodgingUserDetails.class);
                            ...
                            startActivity(t);
                            Toast.makeText(LodgingActivity.this, "DONE!", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
            }
    ...
    public void DATE(){
        ...
        DatePickerDialog dp = new DatePickerDialog(LodgingActivity.this, new DatePickerDialog.OnDateSetListener() {
            @Override
    ...
    public void TIME() {
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(LodgingActivity.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
